...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/YQkymw
...
ALTER TABLE `location` ADD CONSTRAINT `fk_location_address_id` FOREIGN KEY(`address_id`)
...
ALTER TABLE `rota` ADD CONSTRAINT `fk_rota_data` FOREIGN KEY(`data`)
